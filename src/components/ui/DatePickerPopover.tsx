  ...
  function DatePickerPopover(
    ...
    return (
      <div
        ...
        style={style}
        className={`date-picker-popover date-picker-popover--${placement} pointer-events-auto z-[200] isolate overscroll-contain rounded-lg border border-outline-variant bg-surface-container-low p-2.5 shadow-[0_8px_24px_rgba(0,0,0,0.3)]`}
      >
