...
function createLine(): EmisoraLineState {
  return {
...
export function EmisorasOrderLines({
  ...
  const [lines, setLines] = useState<EmisoraLineState[]>(() => [createLine()]);
    ...
    <div className="space-y-4">
      ...
      {lines.map((line, index) => {
        ...
        return (
          <div
            key={line.key}
            className="grid grid-cols-1 sm:grid-cols-12 gap-4 p-4 rounded-lg border border-outline-variant/60 bg-surface-container-lowest/40"
          >
